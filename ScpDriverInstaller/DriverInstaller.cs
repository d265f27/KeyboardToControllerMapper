 ...
 *
 * Any modifications from github.com/mogzol/ScpDriverInterface are copyright 
 * Elliot Dawber 2017, MIT License.
 */
...
namespace ScpDriverInstaller
{
	public partial class DriverInstaller : Form
	{
		...
		public DriverInstaller()
		{
            ...
            bool autoExit = false;
            if (argv.Length > 2 && argv[2] == "autoexit")
            {
                autoExit = true;
            }
            if (argv.Length > 1 && argv[1] == "install")
            {
                installDriver(autoExit);
            }

            if (argv.Length > 1 && argv[1] == "uninstall")
            {
                uninstallDriver(autoExit);
            }
        }
        ...
        private void installDriver(bool autoExit)
        {
        ...
        private void uninstallDriver(bool autoExit)
        {
